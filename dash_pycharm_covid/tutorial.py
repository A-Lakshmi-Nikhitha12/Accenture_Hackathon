...
# Converting date column from string to proper date
...
app.layout = html.Div([
    html.Div([
        ...
        html.Div([
            html.Div([
                    html.H3("Covid-19", style={"margin-bottom": "20px" ,'color':'white'}),
        ...
        id="header", className= "row flex-display" ,style={"margin-bottom": "20px"}),
        ...
        html.Div([
            html.Div([
                ...
                html.P('New Cases : '+' '+' '+str(covid_data_2['date'].iloc[-1].strftime("%B %d, %Y"))+' ',className='fix_label',style={
                    'color':'white',
                    'text-align':'center'
                }),
...
#accesstoken='pk.eyJ1IjoicXM2MjcyNTI3IiwiYSI6ImNraGRuYTF1azAxZmIycWs8cDB1NmY1ZjYifQ.I1VJ3KjeM-S613FLv3mtkw',